...
import { UpdateUserImageApi } from "../../service/operations/userApi";
    ...
    const handleFileSelect = async (e) => {
        ...
        if (file) {
            ...
            if (file.size > maxSizeInBytes) {
                ...
                UpdateUserImageApi(formData, user.id).then((res) => {
    ...
    return (
        <div className="row" >
            <div className="col-12">
                <span className="demo-heading">Profile</span>
            </div>
                ...
                <div className="member-card mt-4 mx-auto">
                    <div className='top d-flex justify-content-between'>
                        <div className='d-flex gap-3 justify-content-start p-3' >
                            <div className=' team-card-image-profile position-relative' >
                                <img
                                    className="h-100 w-100"
                                    src={userimage ? userimage : user !== undefined && user.image !== null ? user.image : `https://avatar.iran.liara.run/username?username=${user ? user.name : "Loading..."}`}
                                />
                                <div className="image-edit" onClick={() => document.getElementById('profileImageInput').click()}>
                            ...
                            <div className='d-flex' >
                                <p className="member-card-text1 text-capitalize my-auto" >{user.name}</p>
                            </div>
                        </div>
                        <div className="d-none my-auto gap-4 p-3" >
                    ...
                    <div className='bg-white p-3' >
                        <div className='mb-3' >
                            ...
                            <p className='member-card-text2 mt-1 mb-0' >{user.department}</p>
                        </div>
                        <div className='mb-3' >
                            <p className='recent-project-card-timeleft mb-1' style={{ fontSize: "14px" }} >Email</p>
                            <p className='member-card-text2 mt-1 mb-0' >{user.email}</p>
                        </div>
                        <div className='mb-3' >
                            <p className='recent-project-card-timeleft mb-1' style={{ fontSize: "14px" }} >Shift Timing</p>
                            <p className='member-card-text2 mt-1 mb-0' >{user.shifttime}</p>
                        </div>
                        <div className='mb-3' >
                            ...
                            <ul className="profile-permission-list" >
                                <li>
                                    <div className="d-flex gap-5" >
                                        ...
                                        <p className='member-card-text2 mb-1' >Yes</p>
                                    </div>
                                </li>
