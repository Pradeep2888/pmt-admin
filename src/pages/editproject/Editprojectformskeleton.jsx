        ...
        <div className=' homepage  p-4 gap-3' style={{ height: "calc(100vh - 3rem)" }} >
            <div className='row' >
                <div className='col-12 d-flex justify-content-between' style={{ height: 'fit-content' }} >
                    <div style={{ cursor: 'pointer' }} onClick={() => Navigate(`/single/project/detail/${params.id}`)} >
            ...
            <div className='col-12 mt-5 '  >
                <div className='demo-heading text-center pb-3' style={{fontSize:"32px"}}  >Edit Project</div>
...
export default Editprojectformskeleton
